    ...
    <React.Fragment>
      <section className="about-me relative mt-16 " id="about-me" ref={ref}>
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-32 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          <article className="pl-60 max-lg:p-0" style={{width:500}}>
            <img src={me} alt={me}/>
          </article>
          <Swiper
            spaceBetween={100}
            ...
            <SwiperSlide
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  ...
                  <div>
                    ...
                    Memorial University of Newfoundland, 2015-2019
                    </h3>
                    <h3 className="text-white text-2xl">Bachelor of Science(BS), Computer Science</h3>
                  </div>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  ...
                  <div>
                    ...
                    Frontend Developer | Sysmap Solutions  Feb 2020 - Dec 2020
                    </h5>
                    <h5 className="text-white text-2xl">
                    Frontend Developer | Superfluid  Jan 2020 - Mar 2022
                    </h5>
                    <h5 className="text-white text-2xl">
                    Senior Full Stack Developer | Go Enterprise Aug 2022 - Aug 2024
                    </h5>
                    <h5 className="text-white text-2xl">
                    Freelancer         Sep 2024 - Present
                    </h5>
                  </div>
                </div>
              </SwiperSlide>
