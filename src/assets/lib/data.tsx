...
export const headerIntroData = {
  ...
  description: {
    ...
    en: "Lucas Kai, a fullstack && blockchain developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const sideBarRightMail = {
  link: "mailto:meilucas8181@gmail.com",
  text: "myemail@com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://github.com/brightdev124",
    icon: FiGithub,
    altimgname: "github",
  },
  {
